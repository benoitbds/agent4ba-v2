                ...
                <div className="mt-2 space-y-2">
                  ...
                  {toolRun.details.error && (
                    <div className="mt-2 p-3 bg-red-50 border border-red-200 rounded">
                      <p className="text-xs font-medium text-red-700">{t("timeline.error")}</p>
