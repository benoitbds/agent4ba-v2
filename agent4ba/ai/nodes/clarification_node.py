...
def ask_for_clarification(state: dict[str, Any]) -> dict[str, Any]:
    ...
    Returns:
        dict: Mise à jour partielle de l'état avec :
            ...
            - status: "awaiting_clarification" pour mettre en pause le workflow
    """
    ...
    # Analyser le contexte pour identifier les éléments pertinents
    ...
    if relevant_items:
        ...
        question = (
            f"Votre requête '{user_query}' est ambiguë. "
            f"Pourriez-vous préciser ce que vous souhaitez faire ?"
        )
