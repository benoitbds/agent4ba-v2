...
async def generate_test_cases_for_item(project_id: str, item_id: str) -> JSONResponse:
    ...
    sans passer par le graphe complet. Les cas de test générés sont automatiquement
    appliqués au WorkItem.
    ...
    Returns:
        JSONResponse avec le WorkItem mis à jour incluant les cas de test
    ...
    try:
        ...
        updated_item = storage.update_work_item_in_backlog(
            ...
            item_id,
            {
                "test_cases": item_after["test_cases"],
                "validation_status": item_after["validation_status"],
            },
        )
